...
const itemGen = (itemObj) => {
    ...
    appendElementToDiv(newElem, titleGen(itemObj.artist));  //appende l'elemento p (artist) al div padre
    appendElementToDiv(newElem, titleGen(itemObj.year));    //appende l'elemento p (year) al div padre
